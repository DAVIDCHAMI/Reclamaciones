...
Característica: Reversión de constitución o ajuste manual de la reserva de un siniestro
  ...
  Esquema del escenario: creación de nueva línea de reserva
    ...
    Cuando se crea una nueva <Línea de Reserva> por <Categoría de costo> de <Tipo de costo> por un valor de <Valor de Pretensión>
    Entonces se genera una nueva Líne de reserva de <Categoría de costo> con un deducible de <Deducible>
    Ejemplos:

      | Tipo y Cobertura                                    | causa         | Tipo de incidente | Línea de Reserva                                     | Categoría de costo  | Tipo de costo                | Valor de Pretensión | Deducible |
