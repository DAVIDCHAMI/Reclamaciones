...
Característica: Constitución de una línea de reserva de un siniestro
  ...
  Esquema del escenario: reversión de constitución
    ...
    Ejemplos:
      ...
      | Multiriesgo corporativo con cobertura básica | Incendio          | 2000000             | Propiedad         | 4000000          | 0         |
      | Multiriesgo corporativo con cobertura básica | Incendio          | 2000000             | Propiedad         | 3800000          | 0         |
