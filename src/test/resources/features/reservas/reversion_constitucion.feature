...
Característica: Reversión de constitución o ajuste manual de la reserva de un siniestro
  ...
  Esquema del escenario: reversión de constitución
    ...
    Ejemplos:
      ...
      | Multiriesgo corporativo con cobertura basica causal Rotura de vidrios | Rotura de vidrios | 2000000             | Propiedad         | 4000000          | -1562484  |
      | Multiriesgo corporativo con cobertura basica causal Rotura de vidrios | Rotura de vidrios | 2000000             | Propiedad         | 50000000         | -5000000  |
