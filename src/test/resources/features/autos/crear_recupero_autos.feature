...
Característica: Crear un recupero de un siniestro
  ...
  Esquema del escenario: crear recupero de subrogación o ingreso (otro)
    ...
    Ejemplos:
      | Línea de reserva                | Tipo de pago | Beneficiario de pago                    | Método de pago | Código de retención pago | ¿Es pago soloSura? | Tipo de cobertura   | Código de retención recupero |
      | (1) 3ª parteLesiones corporales | Parcial      | JHON FEOR FEOR FEOR                     | Pago por banco | 0099                     | No                 | RC Lesión a Persona | 0099                         |
      | (2) 1ª parteVehículo            | Parcial      | MARTHA CECILIA BOTERO OSORIO CQLII      | Caja Sura      | 0099                     | No                 | Perdida total Daños | 0099                         |
