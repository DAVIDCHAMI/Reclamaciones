...
Característica: Distribución del reaseguro de un siniestro
  ...
  Esquema del escenario: Reaseguro Reserva de liberación - Pago y liberación de reserva
    ...
    Ejemplos:
      ...
      | Multiriesgo corporativo con cobertura básica | (1) 1ª partePropiedad | Final     | CLUB LOS TRIUNFADORES CQLII | Pago por banco | No          | 0099             | Pago             | Incendio | 3000000             | Propiedad         |
  ...
  Esquema del escenario: Reversión de constitución
    ...
    Ejemplos:
      ...
      | Multiriesgo corporativo con cobertura básica | Rotura de vidrios | 2000000             | Propiedad         | 50000000         | Reversión Constitución |
