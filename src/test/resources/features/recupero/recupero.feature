...
Característica:Recupero de una reclamacion
  ...
  Esquema del escenario: recupero
    Dado que se tiene un siniestro con una reserva por <tipoReserva>
    Cuando se genere un recupero de tipo <tipoRecupero> con un código de retención <codigoRetencion>
    Entonces se obtiene un reintegro de dinero al siniestro

    Ejemplos:

      |tipoReserva        |tipoRecupero  |codigoRetencion|
