...
Característica: Realizar pago de un siniestro
  ...
  Esquema del escenario: Pago siniestro empresarial
    ...
    Cuando se realice un pago <Tipo de pago> a <Beneficiario del pago> por medio de <Método del pago> el cual cuenta con una línea de reserva <Línea de Reserva> por <Categoría de costo> y <Tipo de costo> donde el responsable <¿Es pago soloSura?> es Sura por una retención de <Código de Retención> el asegurado <¿Es riesgo consultable?> es riesgo consultable
...
#      | (1) 1ª parteContenido                               | Final        | CUATRO TEMPORADAS S.A. CQLII      | Pago por banco  | Costo               | No                 | 0079                | Sustracción con cobertura Sustracción con violencia  | Causas varias                       | 4000000             | Contenido         | No                      | Si                        |
      | (1) 1ª parteContenido - CUATRO TEMPORADAS S.A. CQLII | Parcial      | PINTORES S.A. CQLII II | Pago por banco  | Gastos de siniestro | No                 | 0079                | Sustracción con cobertura Sustracción con violencia | Causas varias | 4000000             | Propiedad         | Si                      | Si                        | Gasto - A&O (ajuste y otros) |
