...
Característica: Realizar pago de un siniestro
  ...
  Esquema del escenario: Pago siniestro empresarial
    ...
    Cuando se realice un pago <Tipo de pago> a <Beneficiario del pago> por medio de <Método del pago> el cual cuenta con una línea de reserva <Línea de Reserva> por <Categoría de costo> de <Tipo de costo> por valor igual a <Valor de Pretensión> donde el responsable <¿Es pago soloSura?> es Sura por una retención de <Código de Retención> el asegurado <¿Es riesgo consultable?> es riesgo consultable
    Entonces <¿Se genera orden de pago?> se genera una orden de pago para que le sea entregado al usuario

    Ejemplos:
      | Línea de Reserva                                     | Tipo de pago | Beneficiario del pago  | Método del pago | Categoría de costo  | ¿Es pago soloSura? | Código de Retención | Tipo y Cobertura                                    | Causa         | Valor de Pretensión | Tipo de incidente | ¿Es riesgo consultable? | ¿Se genera orden de pago? | Tipo de costo                |
...
#      | (1) 1ª parteContenido                               | Final        | CUATRO TEMPORADAS S.A. CQLII      | Pago por banco  | Costo               | No                 | 0079                | Sustracción con cobertura Sustracción con violencia  | Causas varias                       | 4000000             | Contenido         | No                      | Si                        |
      | (1) 1ª parteContenido - CUATRO TEMPORADAS S.A. CQLII | Parcial      | PINTORES S.A. CQLII II | Pago por banco  | Gastos de siniestro | No                 | 0079                | Sustracción con cobertura Sustracción con violencia | Causas varias | 4000000             | Contenido         | Si                      | Si                        | Gasto - A&O (ajuste y otros) |
