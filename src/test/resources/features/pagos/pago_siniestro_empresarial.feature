...
Característica: Realizar pago de un siniestro
  ...
  Esquema del escenario: Pago siniestro empresarial
    ...
    Ejemplos:
      ...
      | (1) 1ª partePropiedad | Final        | AURA JUDITH LOPEZ JULIO CQLII     | Caja Sura       | Sí                 | 0099                | Hogar con cobertura básica                           | Incendio                            | 2000000             | Propiedad         |
      ...
      | (1) 1ª parteContenido | Parcial      | JUAN CARLOS PALACIO RAMIREZ CQLII | Pago por banco  | Sí                  | 0023                | Transportes automáticos de mercancía                 | Amit/ huelga, conmoción civil       | 4000000             | Contenido         |
