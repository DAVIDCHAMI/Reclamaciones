...
#      | (1) 1ª parteContenido | Final        | CUATRO TEMPORADAS S.A. CQLII      | Pago por banco  | No                 | 0079                | Sustracción con cobertura Sustracción con violencia  | Causas varias                       | 4000000             | Contenido         |
  ...
  Esquema del escenario: Pago siniestro empresarial a un Riesgo Consultable
    ...
    Y se realice un pago <Tipo de pago> a <Beneficiario del pago> por medio de <Método del pago> el cual cuenta con una línea de reserva <Línea de Reserva> donde el responsable <¿Es pago soloSura?> es Sura por una retención de <Código de Retención>
    Entonces <¿Genera orden de pago?> se genera una orden de pago para que le sea entregado al usuario

    Ejemplos:
      | Línea de Reserva                                                                                            | Tipo de pago | Beneficiario del pago        | Método del pago | ¿Es pago soloSura? | Código de Retención | Tipo y Cobertura                                    | Causa         | Valor de Pretensión | Tipo de incidente | Exposición                                           | Categoría de costo  | Tipo de costo                | ¿Genera orden de pago? |
      | (1) 1ª parteContenido - CUATRO TEMPORADAS S.A. CQLII; Gasto - A&O (ajuste y otros)/Gastos de siniestro; COP | Final        | CUATRO TEMPORADAS S.A. CQLII | Pago por banco  | No                 | 0079                | Sustracción con cobertura Sustracción con violencia | Causas varias | 4000000             | Contenido         | (1) 1ª parteContenido - CUATRO TEMPORADAS S.A. CQLII | Gastos de siniestro | Gasto - A&O (ajuste y otros) | Si                     |
