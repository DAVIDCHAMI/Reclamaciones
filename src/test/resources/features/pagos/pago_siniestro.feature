...
Característica: Realizar pago de un siniestro
  ...
  Esquema del escenario: Pago siniestro empresarial
    ...
    Ejemplos:
      ...
      | (1) 1ª parteContenido | Final        | BLANCA EUGENIA ACOSTA PATIÑO CQLII| Pago por banco  | No                 | 0023                | Sustracción con cobertura Sustracción con violencia  | Causas varias                       | 4000000             | Contenido         |
      ...
      | (1) 1ª parteContenido | Final        | MARIA CONCEPCION CORREA SANTANA CQLII| Pago por banco  | No                 | 0099                | PES Emergente Amit                                   | Amit/ huelga, conmoción civil       | 2500000             | Contenido         |
