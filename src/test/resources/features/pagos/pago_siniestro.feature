...
Característica: Realizar pago de un siniestro
  ...
  Esquema del escenario: Crear cheque con múltiples pagos a diferentes líneas de reserva de un siniestro autos
    ...
    Cuando se genere un pago <Tipo de pago> al beneficiario <Beneficiario del pago> por el medio de pago de <Método de pago> sobre las líneas de reserva <Línea de reserva 1> y <Línea de reserva 2> donde el responsable <Pago solo Sura> es Sura con una retención de <Código de retención pago> donde existe <Número de vehículos involucrados del tercero en el siniestro> vehículo involucrado del tercero en el siniestro
    Entonces se genera una orden de pago para que le sea entregado al usuario

    Ejemplos:
      | Línea de reserva 1                        |Línea de reserva 2                    | Tipo de pago  | Beneficiario del pago            | Método de pago | Código de retención pago |Cobertura          |Pago solo Sura| Número de vehículos involucrados del tercero en el siniestro|
      | Perdida total Daños pago por en EFECTIVO  |Gastos de Transporte                  | Final         |SOFIA JARAMILLO                   |Pago por banco  | 0099                     |Perdida total Daños|No            | 1                                                           |
