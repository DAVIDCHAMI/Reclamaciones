...
Característica: Realizar un pago masivo a un proveedor
  ...
  Esquema del escenario: Crear pago masivo a un mismo proveedor.
    ...
    Cuando se registra la información de las facturas del pago masivo a un proveedor de <número de vehículos involucrados en el siniestro> vehículos involucrados en el siniestro con coberturas <Coberturas de la póliza>
    ...
    Ejemplos:
      | Tipo de contacto | Proveedor  | Tipo de moneda | Método de pago |número de vehículos involucrados en el siniestro|Coberturas de la póliza          |
