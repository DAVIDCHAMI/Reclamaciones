...
Característica: Notificacion de aviso de una reclamacion
  ...
  Esquema del escenario: aviso
    ...
    Ejemplos:
      ...
      | 9180000015675      | Multiriesgo corporativo 2 |(1) 1ª partePropiedad - JOSE ALFREDO MARTINEZ HERRERA CQLII; Costo de reclamación/Daños materiales; COP     | Final      |JOSE ALFREDO MARTINEZ HERRERA CQLII     | Caja Sura        | No        | 0020               |
