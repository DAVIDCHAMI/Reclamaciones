...
public class ArchivoXLS
{
    ...
    public static void abrirArchivoXls(String rutaArchivoXls, String nombreHojaArchivoXls) throws Exception
    {
    ...
    public static String getCellData(int RowNum, int ColNum) throws Exception{
        ...
        try{
            ...
            if (celda.getCellType()==1){ CellData = celda.getStringCellValue(); }
            if (celda.getCellType()==0){ CellData = celda.getRawValue(); }
            return CellData;
        }catch (Exception e){
            return "";
        }
