...
import static com.sura.reclamaciones.constantes.Posiciones.POSICION_PAGO_MASIVO;
    ...
    try {
      ...
      for (int i = 0; i < placasVehiculosInvolucradosSiniestro.size(); i++) {
        ...
        if(i>=2)
        {
          ...
          listaInformacion.add(
                  4,
                  datosExposicionPagoMasivo.get(j).getCobertura());
          listaInformacion.add(
                  5,
                  datosExposicionPagoMasivo
                          .get(j)
          ...
          listaInformacion.add(
                  ...
                  datosExposicionPagoMasivo
                          ...
                          .getCoverageSubtype());
          listaInformacion.add(
                  8, datosReservaPagoMasivo.get(j).getTipoCosto());
          listaInformacion.add(
                  9, datosReservaPagoMasivo.get(j).getCostType());
          listaInformacion.add(
                  10,
                  datosReservaPagoMasivo.get(j).getCategoriaCosto());
          listaInformacion.add(
                  11,
                  datosReservaPagoMasivo.get(j).getCostCategory());
          listaInformacion.add(
                  12,
                  datosPagoSiniestroPagoMasivo.get(j).getTipoPago());
          listaInformacion.add(
                  13,
          ...
          listaInformacion.add(
                  18,
                  datosPagoSiniestroPagoMasivo.get(j).getImpuesto());
          listaInformacion.add(
                  19,
                  datosPagoSiniestroPagoMasivo
                          .get(j)
