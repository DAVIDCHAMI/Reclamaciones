...
public class InformacionBasicaPage extends GeneralPage {
    ...
    private String XpathTxtDetalleHechos = "//textarea[@id='FNOLWizard:GeneralPropertyWizardStepSet:NewClaimWizard_MainContactsScreen:NewClaimPeopleDV:Description-inputEl']";
