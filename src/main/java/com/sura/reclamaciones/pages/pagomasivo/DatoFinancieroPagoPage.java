  ...
  public void validarPagosIndividualesSiniestro() {
    ...
    List<WebElement> elementoEncontrado =
        obtenerElementoTablaDatoDesconocido(
            tblPagoIndividual,
            RESULTADO_PAGO_INDIVIDUAL,
            Integer.parseInt(POSICION_FILA.getValor()));
    int contadorPagoIndividual =
        Integer.parseInt(
            Serenity.sessionVariableCalled(SESION_CC_NUMERO_PAGO_INDIVIDUAL.getValor()).toString());
    int tamanoLista =
        Integer.parseInt(
            Serenity.sessionVariableCalled(SESION_CC_CANTIDAD_PAGO_INDIVIDUAL.getValor())
                .toString());
