  ...
  public void ingresarInformacionFactura(String tipoCobertura) throws IOException {
    ...
    PagoSiniestro datosPagoSiniestroPagoMasivo =
            new PagoSiniestro(
                    genericStep.getFilasModelo(
                            String.valueOf(PAGO_MASIVO.getValor()), tipoCobertura));
    cargaArchivoPagoMasivoStep.cargarArchivoXls(MenuConstante.ESCRITORIO_MENU, MenuConstante.FACTURAS_VOLUMEN_MENU, datosExposicionPagoMasivo, datosReservaPagoMasivo, datosPagoSiniestroPagoMasivo);
