...
public class ReversionConstitucionDefinition {
    ...
    @Steps
    MovimientoLineaReservaStep movimientoLineaReserva;

    @Steps
    NuevaReclamacionEmpresarialStep reclamacionEmpresarialStep;
    ...
    public void verificarReversionConstitucion(String deducible) {
        consultaDatoFinancieroTransaccionStep.verificarDeducibleReserva(TIPO_CATEGORIA_COSTO_RESERVA, deducible);
    }
}
