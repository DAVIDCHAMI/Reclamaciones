...
public class NotificacionAvisoSiniestroAutoDefinition {
    ...
    @Steps
    private NuevoAvisoSiniestroAutoStep reclamacionStep;
    ...
    public void ingresarDatosSiniestroResponsabilidadCivil(DataTable parametrosSiniestro)
        ...
        exposicionVehiculoTercero =
                new ExposicionVehiculoTercero(
                        genericStep.getFilasModelo(
                                ...
                                resposabilidadCivilVehiculo));
        personaReclamacion =
                new PersonaReclamacion(
                        genericStep.getFilasModelo(
                                PARAMETROS_PERSONA.getValor(), resposabilidadCivilVehiculo));
        ...
        personaReclamacion =
                new PersonaReclamacion(
                        genericStep.getFilasModelo(
                                PARAMETROS_PERSONA.getValor(), resposabilidadCivilLesiones));
        direccionReclamacion =
                new ReclamacionAuto(
                        genericStep.getFilasModelo(
