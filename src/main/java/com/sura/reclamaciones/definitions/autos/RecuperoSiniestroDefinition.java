...
public class RecuperoSiniestroDefinition
{
    ...
    @Dado("^se cree un pago (.*) al beneficiario (.*) por el medio de pago de (.*) sobre la linea de reserva (.*) donde el responsable (.*) es Sura con una retención de (.*)$")
    ...
    public void crearRecuperoReclamacionAutos(String tipoRecupero, String codigoRetencion) throws IOException {
        recupero =
                new Recupero(
