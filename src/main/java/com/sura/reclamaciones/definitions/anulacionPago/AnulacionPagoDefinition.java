...
public class AnulacionPagoDefinition {
    ...
    public void ingresarPagos(String strTipoProducto ) throws Throwable {
        anulacionPagoEmpresarial =
                new AnulacionPagoEmpresarial(genericStep.getFilasModelo("anulacion_pago_empresarial", strTipoProducto));
        anulacionPagoStep.consultarNumeroReclamacion(anulacionPagoEmpresarial.getLstAnulacionPagoEmpresarialPago());
    }

     @Cuando("^se realice una transaccion de Anulación de pago$")
    public void realizarAnulacionPago() {
        anulacionPagoStep.ingresarPagoAnular(anulacionPagoEmpresarial.getLstAnulacionPagoEmpresarialPago());
    }

    @Entonces("^se debe obtener un estado de tipo (.*)$")
    public void seDebeObtenerUnEstadoDeTipoTipoEstado() {

        anulacionPagoStep.verificarAnulacionRealizada(anulacionPagoEmpresarial.getLstAnulacionPagoEmpresarialPago());
