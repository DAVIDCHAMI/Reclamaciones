...
public enum Constantes {
  ...
  DEDUCIBLE_RESERVA_GASTO_EMPRESARIALES("0"),
  ...
  NIT("98630089"),
  NO("no"),
  NOMBRE_CAMPO_CATEGORIA_COSTO_RESERVA_EMPRESARIALES("Categoría de costo"),
  NOMBRE_CAMPO_EXPOSICION_LINEA_RESERVA_EMPRESARIALES("Exposición"),
  NOMBRE_CAMPO_TIPO_COSTO_RESERVA_EMPRESARIALES("Tipo de costo"),
  NOMBRE_CAMPO_VALOR_NUEVA_RESERVA_EMPRESARIALES("Nuevas reservas disponibles"),
  ...
  PORCIENTO("100"),
  POSICION_COLUMNA_RESERVA("0"),
  POSICION_VALOR_RESERVA_EMPRESARIALES("-1"),
  PRIMA("Prima"),
